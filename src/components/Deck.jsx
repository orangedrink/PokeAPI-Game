...
export default function Deck({ playersArray = [], activePokemon }) {
    ...
    <div className="lineup-container">
      ...
      <div className="deck-grid">
        {playersArray.map(card => {
          ...
          return (
            <span className={card.name === activePokemon ? "active card" : "card"} key={card.name}>
              {card.sprite ? <img src={card.sprite} alt={card.name} width={96} height={96}/> : <div className="ph">No image</div>}
